...
const createOqcSchema = Joi.object({
...
const generateDocSchema = Joi.object({
  type: Joi.string().valid('cert', 'coc').required(),
});

const validateCreateOqc   = (data) => createOqcSchema.validate(data,    { abortEarly: false });
const validateUpdateResult = (data) => updateResultSchema.validate(data, { abortEarly: false });
const validateGenerateDoc  = (data) => generateDocSchema.validate(data,  { abortEarly: false });

module.exports = { validateCreateOqc, validateUpdateResult, validateGenerateDoc };
