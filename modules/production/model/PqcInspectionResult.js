...
const PqcInspectionResult = sequelize.define('PqcInspectionResult', {
...
}, { tableName: 'pqc_inspection_results', underscored: true, timestamps: false });

module.exports = PqcInspectionResult;
